...
printf "${BLUE}Targeting source branch: %s${NC}\n" "$RELENG_BRANCH"
...
# 4. Driver source code retrieval
printf "${GREEN}[3/5] Fetching 'aq' driver source code...${NC}\n"
...
update_loader "hw.aq.num_queues" "4"
update_loader "dev.aq.0.iflib.override_nrxqs" "4"
update_loader "dev.aq.0.iflib.override_ntxqs" "4"
